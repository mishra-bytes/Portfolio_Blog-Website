...
export function SubscribeForm() {
  ...
  return (
    <div>
      <h2 className="text-2xl font-semibold text-slate-800">Join the loop.</h2>
      <p className="mt-3 max-w-xl text-slate-600">
        No spam. Just highly technical write-ups on Machine Learning, Computer
        Vision, and system design, delivered straight to your inbox.
      </p>

      {status === "success" ? (
        <p className="mt-8 max-w-2xl text-sm font-medium text-emerald-700">
          ✓ {message}
        </p>
      ) : (
        <form
